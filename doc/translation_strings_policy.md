...
This document provides guidelines for internationalization of the CScoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cscoin_en.ts` remains unchanged.
