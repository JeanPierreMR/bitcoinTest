CScoin Core version *0.15.2* is now available from:

  <https://cscoincore.org/bin/cscoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in cscoin-tx (TheBlueMatt)
