CScoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/cscoin/files/CScoin/cscoin-0.5.4/
...
http://gitorious.org/cscoin/cscoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix CScoin-Qt notifications under Growl 1.3.
Increase required age of CScoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxCScoin properly when installing CScoin-Qt over it. (Windows)
