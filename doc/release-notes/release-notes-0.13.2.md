CScoin Core version 0.13.2 is now available from:

  <https://cscoin.org/bin/cscoin-core-0.13.2/>
...
- #8908 `4a974b2` Update cscoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow cscoin-tx to create v2 transactions (btcdrak)
