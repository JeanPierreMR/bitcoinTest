CScoin Core version 0.9.4 is now available from:

  https://cscoin.org/bin/0.9.4/
...
this update is incompatible with the CScoin system and could lead to consensus
forks.

CScoin Core released binaries from https://cscoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~cscoin/+archive/ubuntu/cscoin
- A third-party or self-compiled CScoin Core

upgrade to CScoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
