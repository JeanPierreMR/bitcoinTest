...
CScoin Core version 0.19.1 is now available from:

  <https://cscoincore.org/bin/cscoin-core-0.19.1/>
...
From CScoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as CScoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, CScoin Core does not yet change appearance when
...
- #17488 fix "cscoind already running" warnings on macOS (fanquake)
