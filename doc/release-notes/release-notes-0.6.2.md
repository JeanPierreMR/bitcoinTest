CScoin version 0.6.2 is now available for download at:
http://sourceforge.net/projects/cscoin/files/CScoin/cscoin-0.6.2/
...
Fixed https://github.com/cscoin/cscoin/issues/1065, a bug that
