CScoin Core version 0.10.4 is now available from:

  <https://cscoin.org/bin/cscoin-core-0.10.4/>
...
- #6953 `43c2789` Split cscoin-tx into its own package
- #6953 `dfe0d4d` Include cscoin-tx binary on Debian/Ubuntu
