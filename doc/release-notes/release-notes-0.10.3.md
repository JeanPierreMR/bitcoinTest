CScoin Core version 0.10.3 is now available from:

  <https://cscoin.org/bin/cscoin-core-0.10.3/>
...
(see https://github.com/cscoin/cscoin/pull/6793, as well as the 0.11.0
