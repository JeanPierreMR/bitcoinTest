CScoin Core version 0.16.1 is now available from:

  <https://cscoincore.org/bin/cscoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting cscoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure cscoind processes are cleaned up when tests end (sdaftuar)
