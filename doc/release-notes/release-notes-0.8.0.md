CScoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/cscoin/files/CScoin/cscoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the CScoin
...
New/changed settings (command-line or cscoin.conf file)
--------------------------------------------------------
