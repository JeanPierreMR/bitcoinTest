...
Assumeutxo is a feature that allows fast bootstrapping of a validating cscoind
...
- [Github issue](https://github.com/cscoin/cscoin/issues/15605)
- [draft PR](https://github.com/cscoin/cscoin/pull/15606)
...
considered active. This is the "traditional" mode of operation for cscoind.
...
**Failure consideration:** if cscoind unexpectedly halts after `m_stop_use` is set on
...
### CScoind restarts sometime after snapshot validation has completed

When cscoind initializes again, what began as the snapshot chainstate is now
