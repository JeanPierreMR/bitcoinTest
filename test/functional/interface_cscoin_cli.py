...
class TestCScoinCli(CScoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `cscoin-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and cscoin-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and cscoin-cli getwalletinfo return expected wallet info")
            ...
            # Test cscoin-cli -generate with -rpcwallet in multiwallet mode.
