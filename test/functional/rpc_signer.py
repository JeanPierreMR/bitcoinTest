...
Verify that a cscoind node can use an external signer command.
...
class RPCSignerTest(CScoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart cscoind with -signer=<cmd>',
