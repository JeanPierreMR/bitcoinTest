...
class WalletCrossChain(CScoinTestFramework):
    ...
    def setup_network(self):
        ...
        with open(self.nodes[1].cscoinconf, 'r', encoding='utf8') as conf:
            conf_data = conf.read()
        with open (self.nodes[1].cscoinconf, 'w', encoding='utf8') as conf:
