...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/cscoin/cscoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(CScoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our cscoind node")
