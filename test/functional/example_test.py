...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the CScoinTestFramework
    pass


class ExampleTest(CScoinTestFramework):
    # Each functional test is a subclass of the CScoinTestFramework class.
    ...
    def custom_method(self):
        ...
        CScoinTestFramework class so other tests can use it."""
