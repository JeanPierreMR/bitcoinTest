...
"""Verify that starting cscoin with -h works as expected."""

from test_framework.test_framework import CScoinTestFramework
from test_framework.util import assert_equal

class HelpTest(CScoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cscoin with -h for help text")
        ...
        self.log.info("Start cscoin with -version for version information")
        ...
        self.log.info("Start cscoind with -fakearg to make sure it does not start")
