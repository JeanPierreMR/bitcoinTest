...
class P2PPermissionsTests(CScoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].cscoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].cscoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
