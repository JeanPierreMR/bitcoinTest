...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/cscoin/cscoin/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(CScoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/cscoin/cscoin/blob/master/doc/tracing.md#tracepoint-validationblock_connected
