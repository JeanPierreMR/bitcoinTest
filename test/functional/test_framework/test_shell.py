...
class TestShell:
    """Wrapper Class for CScoinTestFramework.

    The TestShell class extends the CScoinTestFramework
    ...
    class __TestShell(CScoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by CScoinTestFramework child class.
            self.num_nodes = 1
