...
By default, cscoind will dump mempool on shutdown and
...
class MempoolPersistTest(CScoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent cscoind from writing mempool.dat to disk. Verify that `savemempool` fails")
