...
#ifndef CSCOIN_TEST_SCRIPTNUM10_H
#define CSCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from CScoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // CSCOIN_TEST_SCRIPTNUM10_H
