...
#ifndef CSCOIN_SCRIPT_STANDARD_H
#define CSCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a cscoin address
 */
...
/**
 * Generate a CScoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // CSCOIN_SCRIPT_STANDARD_H
