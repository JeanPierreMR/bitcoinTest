...
#ifndef CSCOIN_UTIL_SYSCALL_SANDBOX_H
#define CSCOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during cscoind initialization if CScoin Core was compiled
...
#endif // CSCOIN_UTIL_SYSCALL_SANDBOX_H
