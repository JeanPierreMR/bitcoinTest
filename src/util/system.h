 ...
 */
#ifndef CSCOIN_UTIL_SYSTEM_H
#define CSCOIN_UTIL_SYSTEM_H
...
extern const char * const CSCOIN_CONF_FILENAME;
extern const char * const CSCOIN_SETTINGS_FILENAME;
