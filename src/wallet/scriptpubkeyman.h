...
#ifndef CSCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define CSCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The CScoin Core wallet was originally a collection of unrelated private
...
#endif // CSCOIN_WALLET_SCRIPTPUBKEYMAN_H
