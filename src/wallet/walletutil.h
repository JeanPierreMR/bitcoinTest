...
#ifndef CSCOIN_WALLET_WALLETUTIL_H
#define CSCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! cscoin from opening the wallet, thinking it was newly created, and
...
#endif // CSCOIN_WALLET_WALLETUTIL_H
