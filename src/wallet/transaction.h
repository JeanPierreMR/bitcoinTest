...
#ifndef CSCOIN_WALLET_TRANSACTION_H
#define CSCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this cscoin node, and set to 0 for transactions that were created
...
#endif // CSCOIN_WALLET_TRANSACTION_H
