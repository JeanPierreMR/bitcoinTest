...
#ifndef CSCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define CSCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // CSCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
