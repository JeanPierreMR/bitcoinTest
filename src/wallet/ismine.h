...
#ifndef CSCOIN_WALLET_ISMINE_H
#define CSCOIN_WALLET_ISMINE_H
 ...
 * https://github.com/cscoin/cscoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
