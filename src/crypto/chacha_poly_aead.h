...
#ifndef CSCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define CSCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@cscoin.
 *
 ...
 *
 * The chacha20-poly1305@cscoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@cscoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@cscoin are relatively fast in
...
#endif // CSCOIN_CRYPTO_CHACHA_POLY_AEAD_H
