...
#ifndef CSCOIN_NODE_CONNECTION_TYPES_H
#define CSCOIN_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/cscoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on CScoin’s Peer-to-Peer Network")
...
#endif // CSCOIN_NODE_CONNECTION_TYPES_H
