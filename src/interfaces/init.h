...
#ifndef CSCOIN_INTERFACES_INIT_H
#define CSCOIN_INTERFACES_INIT_H
...
//! (cscoin-gui, cscoin-node, cscoin-wallet, cscoind, cscoin-qt) and each
...
#endif // CSCOIN_INTERFACES_INIT_H
