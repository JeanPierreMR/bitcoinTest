...
#ifndef CSCOIN_INTERFACES_NODE_H
#define CSCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a cscoin node (cscoind process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or cscoin.conf.
...
#endif // CSCOIN_INTERFACES_NODE_H
