    ...
    mapper(nullptr)
{
    ...
    ui->cscoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->cscoinAtStartup);
    ...
    ui->cscoinAtStartup->setToolTip(ui->cscoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->cscoinAtStartup->setText(ui->cscoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openCScoinConfButton->setToolTip(ui->openCScoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new CScoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->cscoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openCScoinConfButton_clicked()
{
