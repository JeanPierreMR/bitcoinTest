...
#ifndef CSCOIN_QT_GUIUTIL_H
#define CSCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the CScoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "cscoin:" URI into recipient object, return true on successful parsing
