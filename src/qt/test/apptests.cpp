...
//! Entry point for CScoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &CScoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for CScoinGUI tests.
void AppTests::guiTests(CScoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &CScoinGUI::consoleShown, this, &AppTests::consoleTests);
