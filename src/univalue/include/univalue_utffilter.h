...
#ifndef CSCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define CSCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // CSCOIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
