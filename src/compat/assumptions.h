...
#ifndef CSCOIN_COMPAT_ASSUMPTIONS_H
#define CSCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "CScoin cannot be compiled without assertions."
#endif
...
#endif // CSCOIN_COMPAT_ASSUMPTIONS_H
