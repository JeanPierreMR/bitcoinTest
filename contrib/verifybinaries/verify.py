...
"""Script for verifying CScoin Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
cscoincore.org and cscoin.org and compares them.
...
WORKINGDIR = "/tmp/cscoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://cscoincore.org"
HOST2 = "https://cscoin.org"
VERSIONPREFIX = "cscoin-core-"
...
def main(args):
    ...
    if not success:
        print("cscoin.org failed to provide signature file, "
              "but cscoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("cscoin.org and cscoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the CScoin Core binary release "
