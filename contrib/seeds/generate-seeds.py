...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef CSCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define CSCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the cscoin network\n')
    ...
    g.write('#endif // CSCOIN_CHAINPARAMSSEEDS_H\n')
