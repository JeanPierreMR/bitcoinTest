...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of cscoin node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple cscoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple cscoin ports', file=sys.stderr)
