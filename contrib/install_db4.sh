...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the cscoin repository."
  exit 1
fi
...
# See https://github.com/cscoin/cscoin/issues/16064
...
echo 'When compiling cscoind, run `./configure` in the following way:'
echo
